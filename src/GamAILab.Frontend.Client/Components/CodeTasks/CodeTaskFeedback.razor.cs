...
public partial class CodeTaskFeedback : ComponentBase
{
    [CascadingParameter]
    ...
    [Parameter] public string EditorId { get; set; } = "code-feedback-editor";
    ...
    private List<string> ConflictedClaims => ParseStrings(CodeSubmissionFeedback?.HallucinationCheck?.ConflictedClaims);

    private List<string> FeedbackEvidence => ParseStrings(CodeSubmissionFeedback?.AIFeedback?.CodeTaskExecutionEvidence);
